    ...
    <q-card class="WorkSessionsEditModal">
        ...
        <q-card-actions class="WorkSessionsEditModal-footer" align="around">
            ...
            <q-btn
                ...
                :disable="!editSessionModalDataReady || sessionProcessing"
...
export default {
    ...
    computed: {
        ...mapGetters('DevicesSessions', ['editSessionModalData', 'editSessionModalDataReady', 'sessionProcessing']),

        isEditMode() {
            let { id } = this.editSessionModalData;
    ...
    methods: {
        ...mapMutations('DevicesSessions', ['setEditSessionModalOpen', 'clearEditSessionModalData']),
        ...mapActions('DevicesSessions', ['requestCreateSession', 'requestUpdateSession']),
        ...
        async onSubmitClick() {
            ...
            if (!this.isEditMode) {
                let res = await this.requestCreateSession();
                ...
                if (!res) {
                    ...
                    this.setEditSessionModalOpen(false);
                }
            } else {
                let res = await this.requestUpdateSession();
