import { DataInputStreamReader } from "@xeokit/xeokit-sdk/src/plugins/BIMServerLoaderPlugin/lib/DataInputStreamReader.js";
...
function BIMServerPerformanceGeometryLoader(bimServerClient, bimServerClientModel, roid, globalTransformationMatrix, performanceModelBuilder) {
    ...
    this.start = function () {
        ...
        var promise = bimServerClient.getSerializerByPluginClassName(serializerName, pluginCallback);
        if (promise) {
    ...
    function readStart(data) {
        ...
        if (protocolVersion !== 10 && protocolVersion !== 11 && protocolVersion !== 16 && protocolVersion !== 17
            && protocolVersion !== 18 && protocolVersion !== 19 && protocolVersion !== 20) {
        ...
        performanceModelBuilder.gotModelBoundary(boundary, o.multiplierToMm);
        currentState.mode = 1;
