...
import {buildEdgeIndices} from '@xeokit/xeokit-sdk/src/viewer/scene/math/buildEdgeIndices.js';
import {WEBGL_INFO} from '@xeokit/xeokit-sdk/src/viewer/scene/webglInfo.js';

import {PerformanceMesh} from '@xeokit/xeokit-sdk/src/viewer/scene/PerformanceModel/lib/PerformanceMesh.js';
import {PerformanceNode} from '@xeokit/xeokit-sdk/src/viewer/scene/PerformanceModel/lib/PerformanceNode.js';
import {getBatchingBuffer, putBatchingBuffer} from "@xeokit/xeokit-sdk/src/viewer/scene/PerformanceModel/lib/batching/batchingBuffer.js";
import {BatchingLayer} from '@xeokit/xeokit-sdk/src/viewer/scene/PerformanceModel/lib/batching/batchingLayer.js';
import {InstancingLayer} from '@xeokit/xeokit-sdk/src/viewer/scene/PerformanceModel/lib/instancing/instancingLayer.js';
import {RENDER_FLAGS} from '@xeokit/xeokit-sdk/src/viewer/scene/PerformanceModel/lib/renderFlags.js';
...
class PerformanceModel extends Component {
     ...
     *
     * If empty value supplied - sets default value ````[0,0,0]````
     *
     * @param {Number[]} position
     */
    set position(position) {
        this._position = new Float32Array(position || [0, 0, 0]);
        math.composeMat4(this._position, this._quaternion, this._scale, this._worldMatrix);
    }
    ...
    /**
     * Sets the PerformanceModel's local scale.
     *
     * If empty value supplied - sets default ````[1,1,1]````
     *
     * @param {Number[]} scale
     */
    set scale(scale) {
        this._scale = new Float32Array(scale || [1, 1, 1]);
        math.composeMat4(this._position, this._quaternion, this._scale, this._worldMatrix);
    }
