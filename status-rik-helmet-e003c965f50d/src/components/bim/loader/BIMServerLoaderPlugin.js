...
import {PerformanceModel} from "./PerfomanceModel.js";

import {BIMServerPerformanceGeometryLoader} from "./BIMServerPerformanceGeometryLoader.js";
import {loadBIMServerMetaModel} from "@xeokit/xeokit-sdk/src/plugins/BIMServerLoaderPlugin/lib/loadBIMServerMetaModel.js";
        ...
        bimServerClient.getModel(poid, roid, schema, false, bimServerClientModel => {  // TODO: Preload not necessary combined with the bruteforce tree
            ...
            loadBIMServerMetaModel(viewer, modelId, poid, roid, schema, bimServerClientModel).then(function () {
                ...
                const loader = new BIMServerPerformanceGeometryLoader(bimServerClient, bimServerClientModel, roid, null, {
                    ...
                    gotModelBoundary: function (boundary, multiplierToMm) {
                        ...
                        // performanceModel.position = center;
                        // performanceModel.scale = [scale, scale, scale];
                    },
